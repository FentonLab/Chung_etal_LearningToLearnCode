...
Animal_name = {'GadR4','Gad9','GadR10','GadR11','GadR14','GadR24','GadR28'};  %Initial training
...
raw_slope_GadR4_R1=load('CSDSlope_112118_GadR4_IO.mat'); % 
raw_slope_GadR9_R1=load('CSDSlope_112118_GadR9_IO.mat'); %  
raw_slope_GadR10_R1=load('CSDSlope_112118_GadR10_IO.mat'); %  
raw_slope_GadR11_R1=load('CSDSlope_112118_GadR11_IO.mat'); %  
raw_slope_GadR14_R1=load('CSDSlope_112118_GadR14_IO.mat'); %  
raw_slope_GadR24_R1=load('CSDSlope_112118_GadR24_IO.mat'); % 
raw_slope_GadR28_R1=load('CSDSlope_112118_GadR28_IO.mat'); % 
raw_slope_GadR4_R2=load('CSDSlope_112118_GadR4_IO_w_optic.mat'); % 
raw_slope_GadR9_R2=load('CSDSlope_112118_GadR9_IO_w_optic.mat'); %  
raw_slope_GadR10_R2=load('CSDSlope_112118_GadR10_IO_w_optic.mat'); %  
raw_slope_GadR11_R2=load('CSDSlope_112118_GadR11_IO_w_optic.mat'); %  
raw_slope_GadR14_R2=load('CSDSlope_112118_GadR14_IO_w_optic.mat'); %
raw_slope_GadR24_R2=load('CSDSlope_112118_GadR24_IO_w_optic.mat'); % 
raw_slope_GadR28_R2=load('CSDSlope_112118_GadR28_IO_w_optic.mat'); % 

raw_depth_GadR4_R1=load('CSDDepth_112118_GadR4_IO.mat'); % 
raw_depth_GadR9_R1=load('CSDDepth_112118_GadR9_IO.mat'); %  
raw_depth_GadR10_R1=load('CSDDepth_112118_GadR10_IO.mat'); %  
raw_depth_GadR11_R1=load('CSDDepth_112118_GadR11_IO.mat'); %  
raw_depth_GadR14_R1=load('CSDDepth_112118_GadR14_IO.mat'); % 
raw_depth_GadR24_R1=load('CSDDepth_112118_GadR24_IO.mat'); % 
raw_depth_GadR28_R1=load('CSDDepth_112118_GadR28_IO.mat'); % 
raw_depth_GadR4_R2=load('CSDDepth_112118_GadR4_IO_w_optic.mat'); % 
raw_depth_GadR9_R2=load('CSDDepth_112118_GadR9_IO_w_optic.mat'); %  
raw_depth_GadR10_R2=load('CSDDepth_112118_GadR10_IO_w_optic.mat'); %  
raw_depth_GadR11_R2=load('CSDDepth_112118_GadR11_IO_w_optic.mat'); %  
raw_depth_GadR14_R2=load('CSDDepth_112118_GadR14_IO_w_optic.mat'); %   
raw_depth_GadR24_R2=load('CSDDepth_112118_GadR24_IO_w_optic.mat'); % 
raw_depth_GadR28_R2=load('CSDDepth_112118_GadR28_IO_w_optic.mat'); % 
...
chid_GadR4 = [4, 9, 10, 12];% 
chid_GadR9 = [9, 11, 14, 16]; % 
chid_GadR10 = [5, 8, 12, 14]; % 
...
%             %%%%%%%%%%%%%%%%%%%%%%%%%% removal%%%%%%%%%%%%%%%%
            ...
            avg_func_auc =@(x) interp1(Intensity_list,slope_animal(i,:,j,k),x,'linear'); %avg_func_auc =@(x) interp1(Intensity_list,slope_animal_normalized(i,:,j,k),x,'linear');
