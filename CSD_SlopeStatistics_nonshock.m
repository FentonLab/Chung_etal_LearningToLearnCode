...
Animal_name = {'PP19','PP20','PP23','PP25','PPw6'};
...
%-[0] Load the data
%------------------------
raw_slope_PP19=load('CSDSlope_100918_PP19_nonshock_re.mat');   
raw_slope_PP20=load('CSDSlope_100918_PP20_nonshock_re.mat');   
raw_slope_PP23=load('CSDSlope_100918_PP23_nonshock_re.mat');   
raw_slope_PP25=load('CSDSlope_100918_PP25_nonshock.mat');  
raw_slope_PPw6=load('CSDSlope_100918_PPw6_nonshock2.mat'); 
% Load max slope
...
slope_PP20=raw_slope_PP20.Slope_data(Session_selection,:,:,:);
slope_PP23=raw_slope_PP23.Slope_data(Session_selection,:,:,:);
slope_PP25=raw_slope_PP25.Slope_data(Session_selection,:,:,:);
slope_PPw6=raw_slope_PPw6.Slope_data(Session_selection,:,:,:);



[Total_number_session, num_Stimulus_different, num_channel, stimulus_experiment_number]=size(slope_PP20);


%%
%- Initialization of the data set

chid_PP19 = [1, 4, 6, 7, 14]; 
chid_PP20 = [8, 17, 18, 19, 29];
chid_PP23 = [5, 13, 15, 16, 23];  
chid_PP25 = [4, 16, 17, 18, 28];
chid_PPw6 = [5, 6, 7, 8, 12];

raw_chid=[chid_PP19; chid_PP20; chid_PP23;chid_PP25;chid_PPw6];
...
Slope_data(:,:,:,1)=slope_PP19;
Slope_data(:,:,:,2)=slope_PP20;
Slope_data(:,:,:,3)=slope_PP23;
Slope_data(:,:,:,4)=slope_PP25;
Slope_data(:,:,:,5)=slope_PPw6;
