...
Animal_name = {'PP2','PP3','PP4','PP19','PP23'};  %Initial training
...
%-[0] Load the data
raw_slope_PP2=load('CSDSlope_041217_pp2_contB.mat');  
raw_slope_PP3=load('CSDSlope_041217_PP3_contB.mat');  
raw_slope_PP4=load('CSDSlope_041217_PP4_contB.mat');     
raw_slope_PP19=load('CSDSlope_100918_PP19_contB.mat');  
raw_slope_PP23=load('CSDSlope_100918_PP23_contB.mat');  
...
slope_PP19=raw_slope_PP19.Slope_data(Session_selection,:,:,:);
...
chid_PP2 = [1, 3, 5, 7, 14]; % contA: [1, 4, 5, 6, 13] for contB: [1, 3, 6, 7, 15];
...
chid_PP19 =[1, 4, 5, 6, 13]; %depth: 22/8 contB[1,1,18,19,30]
chid_PP23 = [5, 12, 14, 15, 22]; 

raw_chid=[chid_PP2; chid_PP3; chid_PP4; chid_PP19; chid_PP23];
...
%%
Slope_data(:,1:2:11,1:num_Stimulus_different16,1)=slope_PP2(:,1:6,:);
Slope_data(:,1:2:11,1:num_Stimulus_different16,2)=slope_PP3(:,1:6,:);
Slope_data(:,1:2:11,1:num_Stimulus_different16,3)=slope_PP4(:,1:6,:);
Slope_data(:,:,:,4)=slope_PP19;
Slope_data(:,:,:,5)=slope_PP23;
