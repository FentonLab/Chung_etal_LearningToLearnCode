...
Animal_name = {'GadR3','Gad5','Gad12','Gad13','Gad16','GadR27'};  %Initial training
...
raw_slope_GadR3_R1=load('CSDSlope_112118_GadR3_IO.mat'); % 
raw_slope_GadR5_R1=load('CSDSlope_112118_GadR5_IO.mat'); %  
raw_slope_GadR12_R1=load('CSDSlope_112118_GadR12_IO.mat'); %  
raw_slope_GadR13_R1=load('CSDSlope_112118_GadR13_IO.mat'); %  
raw_slope_GadR16_R1=load('CSDSlope_112118_GadR16_IO.mat'); %  
raw_slope_GadR27_R1=load('CSDSlope_112118_GadR27_IO.mat'); % 
raw_slope_GadR3_R2=load('CSDSlope_112118_GadR3_IO_w_optic.mat'); % 
raw_slope_GadR5_R2=load('CSDSlope_112118_GadR5_IO_w_optic.mat'); %  
raw_slope_GadR12_R2=load('CSDSlope_112118_GadR12_IO_w_optic.mat'); %  
raw_slope_GadR13_R2=load('CSDSlope_112118_GadR13_IO_w_optic.mat'); %  
raw_slope_GadR16_R2=load('CSDSlope_112118_GadR16_IO_w_optic.mat'); %  
raw_slope_GadR27_R2=load('CSDSlope_112118_GadR27_IO_w_optic.mat'); % 


raw_depth_GadR3_R1=load('CSDDepth_112118_GadR3_IO.mat'); % 
raw_depth_GadR5_R1=load('CSDDepth_112118_GadR5_IO.mat'); %  
raw_depth_GadR12_R1=load('CSDDepth_112118_GadR12_IO.mat'); %  
raw_depth_GadR13_R1=load('CSDDepth_112118_GadR13_IO.mat'); %  
raw_depth_GadR16_R1=load('CSDDepth_112118_GadR16_IO.mat'); % 
raw_depth_GadR27_R1=load('CSDDepth_112118_GadR27_IO.mat'); % 
raw_depth_GadR3_R2=load('CSDDepth_112118_GadR3_IO_w_optic.mat'); % 
raw_depth_GadR5_R2=load('CSDDepth_112118_GadR5_IO_w_optic.mat'); %  
raw_depth_GadR12_R2=load('CSDDepth_112118_GadR12_IO_w_optic.mat'); %  
raw_depth_GadR13_R2=load('CSDDepth_112118_GadR13_IO_w_optic.mat'); %  
raw_depth_GadR16_R2=load('CSDDepth_112118_GadR16_IO_w_optic.mat'); %   
raw_depth_GadR27_R2=load('CSDDepth_112118_GadR27_IO_w_optic.mat'); %  
...
slope_GadR3_R1=raw_slope_GadR3_R1.Slope_data(Session_selection,:,:);
slope_GadR3_R2=raw_slope_GadR3_R2.Slope_data(Session_selection,:,:);
slope_GadR5_R1=raw_slope_GadR5_R1.Slope_data(Session_selection,:,:);
slope_GadR5_R2=raw_slope_GadR5_R2.Slope_data(Session_selection,:,:);
slope_GadR12_R1=raw_slope_GadR12_R1.Slope_data(Session_selection,:,:);
slope_GadR12_R2=raw_slope_GadR12_R2.Slope_data(Session_selection,:,:);
slope_GadR13_R1=raw_slope_GadR13_R1.Slope_data(Session_selection,:,:);
slope_GadR13_R2=raw_slope_GadR13_R2.Slope_data(Session_selection,:,:);
slope_GadR16_R1=raw_slope_GadR16_R1.Slope_data(Session_selection,:,:);
slope_GadR16_R2=raw_slope_GadR16_R2.Slope_data(Session_selection,:,:);
slope_GadR27_R1=raw_slope_GadR27_R1.Slope_data(Session_selection,:,:);
slope_GadR27_R2=raw_slope_GadR27_R2.Slope_data(Session_selection,:,:);

depth_GadR3_R1=raw_depth_GadR3_R1.Depth_data(Session_selection,:,:);
depth_GadR3_R2=raw_depth_GadR3_R2.Depth_data(Session_selection,:,:);
depth_GadR5_R1=raw_depth_GadR5_R1.Depth_data(Session_selection,:,:);
depth_GadR5_R2=raw_depth_GadR5_R2.Depth_data(Session_selection,:,:);
depth_GadR12_R1=raw_depth_GadR12_R1.Depth_data(Session_selection,:,:);
depth_GadR12_R2=raw_depth_GadR12_R2.Depth_data(Session_selection,:,:);
depth_GadR13_R1=raw_depth_GadR13_R1.Depth_data(Session_selection,:,:);
depth_GadR13_R2=raw_depth_GadR13_R2.Depth_data(Session_selection,:,:);
depth_GadR16_R1=raw_depth_GadR16_R1.Depth_data(Session_selection,:,:);
depth_GadR16_R2=raw_depth_GadR16_R2.Depth_data(Session_selection,:,:);
depth_GadR27_R1=raw_depth_GadR27_R1.Depth_data(Session_selection,:,:);
depth_GadR27_R2=raw_depth_GadR27_R2.Depth_data(Session_selection,:,:);



[Total_number_session, num_Stimulus_different, num_channel]=size(slope_GadR3_R1);
num_Stimulus_different16=size(slope_GadR3_R1,2);   
...
chid_GadR3 = [5, 7, 11, 13];% 
chid_GadR5 = [8, 11, 13, 15]; % 
chid_GadR12 = [8, 10, 12, 15]; % 
chid_GadR13 = [6, 9, 12, 14]; % 
chid_GadR16 = [11, 12, 13, 15]; % 
chid_GadR27 = [6, 8, 12, 14]; 


raw_chid=[chid_GadR3; chid_GadR5; chid_GadR12; chid_GadR13; chid_GadR16; chid_GadR27];
...
%%
Slope_data(:,:,:,1,1)=slope_GadR3_R1(:,:,:);
Slope_data(:,:,:,1,2)=slope_GadR3_R2(:,:,:);
Slope_data(:,:,:,2,1)=slope_GadR5_R1(:,:,:);
Slope_data(:,:,:,2,2)=slope_GadR5_R2(:,:,:);
Slope_data(:,:,:,3,1)=slope_GadR12_R1(:,:,:);
Slope_data(:,:,:,3,2)=slope_GadR12_R2(:,:,:);
Slope_data(:,:,:,4,1)=slope_GadR13_R1(:,:,:);
Slope_data(:,:,:,4,2)=slope_GadR13_R2(:,:,:);
Slope_data(:,:,:,5,1)=slope_GadR16_R1(:,:,:);
Slope_data(:,:,:,5,2)=slope_GadR16_R2(:,:,:);
Slope_data(:,:,:,6,1)=slope_GadR27_R1(:,:,:);
Slope_data(:,:,:,6,2)=slope_GadR27_R2(:,:,:);

Depth_data(:,:,:,1,1)=depth_GadR3_R1(:,:,:);
Depth_data(:,:,:,1,2)=depth_GadR3_R2(:,:,:);
Depth_data(:,:,:,2,1)=depth_GadR5_R1(:,:,:);
Depth_data(:,:,:,2,2)=depth_GadR5_R2(:,:,:);
Depth_data(:,:,:,3,1)=depth_GadR12_R1(:,:,:);
Depth_data(:,:,:,3,2)=depth_GadR12_R2(:,:,:);
Depth_data(:,:,:,4,1)=depth_GadR13_R1(:,:,:);
Depth_data(:,:,:,4,2)=depth_GadR13_R2(:,:,:);
Depth_data(:,:,:,5,1)=depth_GadR16_R1(:,:,:);
Depth_data(:,:,:,5,2)=depth_GadR16_R2(:,:,:);
Depth_data(:,:,:,6,1)=depth_GadR27_R1(:,:,:);
Depth_data(:,:,:,6,2)=depth_GadR27_R2(:,:,:);
...
depth_animal_normalized=zeros(Total_number_session,Effective_intensity_max,Total_num_channel_analysis,Total_num_animal);
...
depth_animal_normalized_optic=zeros(Total_number_session,Effective_intensity_max,Total_num_channel_analysis,Total_num_animal);
...
for i=1:Total_number_session
    for j=1:Total_num_channel_analysis
        ...
        animal_index=[];
        for k=1:Total_num_animal %%%%%%%%%%%%%-WARNING----Total_num_animal16 was chosen 
