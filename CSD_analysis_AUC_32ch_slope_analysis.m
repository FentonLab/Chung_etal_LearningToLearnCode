f%%%%%%%%%%%%%%%%%%%%%%%%%%CSD_analysis_AUC_32ch_HM4_slope_analysis.m%%%%%%%%%%%%%%%%%
%
...
channel32=0; % ACTIVATE CHANNEL32

%-------training------
strCSD=load('CSDToTAUC_20170426_pp4_training.mat');
%strCSD=load('CSDToTAUC_20170426_pp2_training.mat');
%strCSD=load('CSDToTAUC_20170426_pp3_training_1_channel_shifted.mat');

%strCSD=load('CSDToTAUC_031319_PP2_training.mat');
%strCSD=load('CSDToTAUC_031319_PP3_training.mat');
%strCSD=load('CSDToTAUC_031319_PP4_training.mat');
%strCSD=load('CSDToTAUC_031319_PP5_training_1_channel_shifted.mat');

%strCSD=load('CSDToTAUC_20171316_pp7.mat');
%strCSD=load('CSDToTAUC_20171316_pp12.mat');
%strCSD=load('CSDToTAUC_20181004_PP12_training_corrected.mat');

%strCSD=load('CSDToTAUC_20181004_PP13_training.mat'); cannot useable

%strCSD=load('CSDToTAUC_20171316_pp15.mat');
%strCSD=load('CSDToTAUC_20181004_PP15_training.mat');

%-- Corrected : PP15
%strCSD=load('CSDToTAUC_20171316_shiftedDnch1_pp15.mat');

%strCSD=load('CSDToTAUC_20180508_PP20_training_shifting_corrected.mat');  %2to 3 shift 2 (16to14
%-- Corrected : PP20
%strCSD=load('CSDToTAUC_20180512_shiftedDnch2_PP20_training.mat');  %2to 3 shift 2 (16to14
%strCSD=load('CSDToTAUC20181004_PP20_training_re.mat');  %2to 3 shift 2 (16to14
%strCSD=load('CSDToTAUC_20181004_PP20_training_re_shiftingcorrected.mat');  %2to 3 shift 2 (16to14

%strCSD=load('CSDToTAUC_20180508_PP23_training.mat');   
%strCSD=load('CSDToTAUC_20180508_PP23_training_1_channel_shifted.mat');   

%strCSD=load('CSDToTAUC_20181003_PP25_training_correction.mat');   % to be checked
%strCSD=load('CSDToTAUC_20181004_PPw6_training_correction.mat'); %to be checked

%-----contB------
%strCSD=load('CSDToTAUC_20170501_pp2_ContB.mat');
%strCSD=load('CSDToTAUC_20170501_pp3_ContB.mat');
%strCSD=load('CSDToTAUC_20170501_pp4_ContB.mat');
%strCSD=load('CSDToTAUC_20180508_PP19_contB.mat'); %OK
%strCSD=load('CSDToTAUC_20180508_PP23_contB.mat'); %OK


%--------conflict-------
%strCSD=load('CSDToTAUC_20170501_conflict_pp3.mat');
%strCSD=load('CSDToTAUC_20170501_conflict_pp4.mat');
%strCSD=load('CSDToTAUC_20171316_pp7_conflict.mat');
%strCSD=load('CSDToTAUC_20171316_pp15_conflict.mat');
%strCSD=load('CSDToTAUC_20180508_PP23_conflict.mat');  %ok%


%------NS control------
%strCSD=load('CSDToTAUC_20180508_PP19_nonshock.mat'); 
%strCSD=load('CSDToTAUC_20180508_PP19_nonshock_1_channel_shifted.mat'); 
%strCSD=load('CSDToTAUC_20180508_PP25_nonshock.mat'); %ok
%strCSD=load('CSDToTAUC_20180508_PP23_nonshock.mat'); % 
%-- Corrected : PP23 noshock
%strCSD=load('CSDToTAUC_20180513_32ch_shiftedUpch1_PP23_nonshock.mat');  %8to9 3ch- (16to 13)
%strCSD=load('CSDToTAUC_20180513_shiftedDnch1_PP23_nonshock_new.mat');  %8to9 3ch- (16to 13)
%strCSD=load('CSDToTAUC_20180508_PP20_nonshock.mat');  %8to9 4ch- (16to 12) 
%-- Corrected : PP20 noshock
%strCSD=load('CSDToTAUC_20180512_shiftedDnch2_PP20_nonshock_new.mat');  %8to9 3ch- (16to 13)
%strCSD=load('CSDToTAUC_20180508_PP20_nonshock_2_channel_shifted_2_channel_shifted.mat');  %8to9 3ch- (16to 13)
%strCSD=load('CSDToTAUC20181004_PP20_NS_re.mat')
%strCSD=load('CSDToTAUC_20181004_PP20_NS_re_shiftingcorrected.mat')
%strCSD=load('CSDToTAUC_20181004_PPw6_nonshock_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw6_NS_re.mat'); %to be checked


%-----water control-------
%strCSD=load('CSDToTAUC_20181004_PPw1_training_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw2_training_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw3_training_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw4_training_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw5_training_correction.mat'); %to be checked

%strCSD=load('CSDToTAUC_20181004_PPw1_water_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw2_water_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw3_water_correction.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw4_water_re.mat'); %to be checked
%strCSD=load('CSDToTAUC_20181004_PPw5_water_correction.mat'); %to be checked



%---2m retention----
%strCSD=load('CSDToTAUC20181003_PP2_2m_reten.mat'); %ok to be checked
%strCSD=load('CSDToTAUC20181003_PP3_2m_reten.mat'); %ok to be checked
%strCSD=load('CSDToTAUC20181003_PP4_2m_reten.mat'); %ok to be checked
%strCSD=load('CSDToTAUC_20181003_PPw1_2m_reten.mat'); %ok to be checked
%strCSD=load('CSDToTAUC_20181003_PPw3_2m_reten.mat'); %ok to be checked
%strCSD=load('CSDToTAUC_20181003_PPw5_2m_reten.mat'); %ok to be checked
...
for x=1:Total_number_session_truncated
    ...
    for j =1:DataS(session_test,1).num_channel
            plot(time_test,CSDToT(j,:,session_test,animal_test,Intensity_index)*4+(num_channel-j)*300)
...
for w = [1,9]
    ...
    for j =1:DataS(w,1).num_channel
            plot(time_test,CSDToT(j,:,w,animal_test,Intensity_index)*2+(num_channel-j)*300);
%           plotNoStimulusErrorbar(DataS(before),getAverage(DataS(before),j,Intensity,channel32)*1+(DataS(before).num_channel-j)*0.0090,j);
...
if initialization_flag==1
   ...
   CSD_Integral_data=zeros(Total_number_session_truncated, Effective_intensity_max32, num_channel, Total_num_animal);
    ...
    Slope_load=load('CSDSlope_041217_pp4_1.mat');
    Depth_load=load('CSDDepth_041217_pp4_1.mat');
    Time_load=load('CSDTIME_041217_pp4_1.mat');
    AUC_load=load('CSDAUC_041217_pp4_1.mat');
    
    %-- 11/6/17 new data structure
    Section_Index_load=load('CSDSecIndex_073019_PP4_2m.mat');
    PopSpike_Channel_load=load('CSDPopChannel_073019_PP4_2m.mat');
    AUC_DGU_load=load('CSDAUC_DGU_073019_PP4_2m.mat');
% %     
...
%% 1. 11/6/17 Old slope and depth reuse. Uncomment the next three lines and run.
...
flag_manual=2;    % 2:Semi-Manual 1: Manual 0: Automatic
...
%---Section division---
ch_SLM_start = 3;   
ch_DGU_neg_start = 6;          % upper level starting channel
ch_DGU_pos_start = 9;       % upper level - Dendritic ending channel
ch_DGL_pos_start = 12;            %  Lower level soma starting channel
ch_DGL_neg_start = 14;            %  lower level dendritic starting channel

%---Population Spike reference channel
PopSpike_reference_CA1_ch= 1;
PopSpike_reference_DGU_ch= 7;
PopSpike_reference_DGL_ch= 10;
%----------------------
    
Intensity=0;    
test_session=10;           % Session number (before after...etc)
test_ch=14;                % Channel number %pp5: 20 24 29 %pp7: 18 22 26 %pp12: 19 24 30 %pp13: 
...
%%%%%%%%%%%%%%% FIRST PEAK TIMING %%%%%%%%%%%%%%%
start_window_time =9/milisecond;
end_window_time  =10/milisecond;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlim_min=0;
xlim_max=20;              % 2:Semi-Manual 1: Manual 0: Automatic
...
if saving_flag==1
    save('CSDSlope_100918_PP4_training','Slope_data', 'Slope_data_max', 'Slope_data_curv_max')
    save('CSDDepth_100918_PP4_training','Depth_data')
    save('CSDTIME_100918_PP4_training','Time_data')
    save('CSDAUC_100918_PP4_training','CSD_Integral_data')
    save('CSDAUC_100918_PP4_training','CSD_AUC_DGU_data'); %why there is only 1?
    
    save('CSDSecIndex_100918_PP4_training','Section_Index_data');
    save('CSDPopChannel_100918_PP4_training','PopSpike_Channel_data');
...
Slope_load=load('CSDSlope_031319_PP7_training.mat');
Depth_load= load('CSDDepth_031319_PP7_training.mat');
Time_load=load('CSDTIME_031319_PP7_training.mat');
