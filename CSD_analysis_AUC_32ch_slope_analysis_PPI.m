...
%strCSD=load('CSDToTAUC20181003_GadR3_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR4_PPI_110.mat');
%strCSD=load('CSDToTAUC20181003_GadR5_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR9_PPI_370.mat');
%strCSD=load('CSDToTAUC20181003_GadR10_PPI_225.mat');
%strCSD=load('CSDToTAUC20181003_GadR11_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR12_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR13_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR14_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR16_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR20_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR22_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR23_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR24_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR25_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR26_PPI.mat');
%strCSD=load('CSDToTAUC20181003_GadR27_PPI.mat');
strCSD=load('CSDToTAUC20181003_GadR28_PPI.mat');
...
for x=1:Total_number_session_truncated
    ...
    for j =1:DataS(session_test,1).num_channel
            plot(time_test,CSDToT(j,:,session_test,animal_test,Intensity_index)+(num_channel-j)*300)
...
for w = 1:Total_number_session_truncated
...
if initialization_flag==1
   ...
   CSD_Integral_data=zeros(Total_number_session_truncated, Effective_intensity_max32, num_channel, Total_num_animal);
    ...
    Slope_load=load('CSDSlope_112118_GadR27_R1.mat');
    Depth_load=load('CSDDepth_112118_GadR27_R1.mat');
    Time_load=load('CSDTIME_112118_GadR27_R1.mat');
    AUC_load=load('CSDAUC_112118_GadR27_R1.mat');
    
    %-- 11/6/17 new data structure
    Section_Index_load=load('CSDSecIndex_112118_GadR27_R1.mat');
    PopSpike_Channel_load=load('CSDPopChannel_112118_GadR27_R1.mat');
    AUC_DGU_load=load('CSDAUC_DGU_112118_GadR27_R1.mat');
% %     
...
%---Section division---
ch_SLM_start = 3;
ch_DGU_neg_start = 5;          % DG upper level starting channel
ch_DGU_pos_start = 8;       % DG upper level - Dendritic ending channel
ch_DGL_pos_start = 11;            %  DG Lower level soma starting channel
ch_DGL_neg_start = 13;            %  DG lower level dendritic starting channel

%---Population Spike reference channel
PopSpike_reference_CA1_ch=1;
PopSpike_reference_DGU_ch= 8;
PopSpike_reference_DGL_ch= 12;
%----------------------

Intensity=90;    
test_session=1;           % Session number (before after...etc)
test_ch=6;                % Channel number %pp5: 20 24 29 %pp7: 18 22 26 %pp12: 19 24 30 %pp13: 
...
%%%%%%%%%%%%%%% FIRST PEAK TIMING %%%%%%%%%%%%%%%
start_window_time = (t2+0.1)/milisecond;
end_window_time  =start_window_time+0.1/milisecond;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if saving_flag==1
    save('CSDSlope_112118_GadR27_R1','Slope_data', 'Slope_data_max', 'Slope_data_curv_max')
    save('CSDDepth_112118_GadR27_R1','Depth_data')
    save('CSDTIME_112118_GadR27_R1','Time_data')
    save('CSDAUC_112118_GadR27_R1','CSD_Integral_data')
    save('CSDAUC_DGU_112118_GadR27_R1.mat','CSD_AUC_DGU_data'); %why there is only 1?
    
    save('CSDSecIndex_112118_GadR27_R1','Section_Index_data')
    save('CSDPopChannel_112118_GadR27_R1','PopSpike_Channel_data');
